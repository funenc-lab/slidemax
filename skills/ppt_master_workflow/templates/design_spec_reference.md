...
| 文件名       | 尺寸                        | 比例   | 用途     | 类型                                         | 状态                 | 来源                         | 生成描述 / 来源备注 |
| ------------ | --------------------------- | ------ | -------- | -------------------------------------------- | -------------------- | ---------------------------- | ------------------ |
| cover_bg.png | {canvas_info['dimensions']} | [比例] | 封面背景 | [背景图/实景照片/插画配图/图表架构/装饰图案] | [待生成/已有/占位符] | [AI生成/用户提供/商用图库] | [AI提示词/来源备注] |

**状态说明**:

- **待生成** - 需要 AI 生成，提供详细描述
- **已有** - 用户已有图片或已本地化的商用图库图片，直接放入 `images/` 或 `images/stock/`
- **占位符** - 暂不处理，SVG 中用虚线框占位

**来源说明**:

- **AI生成** - 后续进入 Image_Generator 阶段
- **用户提供** - 用户直接提供本地素材
