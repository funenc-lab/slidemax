# PPT Master Command Reference

[中文](./README_CN.md) | English

This directory contains the canonical command entry points for the PPT Master workflow.

## Current Rules

- Use `skills/ppt_master_workflow/commands/` as the canonical command surface.
- Use `skills/ppt_master_workflow/pptmaster/` as the shared Python core.
