...
This directory stores the canonical workflow entry documents for the `ppt-master-workflow` skill.
...
- Treat `skills/ppt_master_workflow/` as the only workflow source of truth.
