...
```bash
mkdir -p "skills/ppt_master_workflow/templates/layouts/<新模板名称>"
```

> ⚠️ **输出位置**：全局模板输出到 `skills/ppt_master_workflow/templates/layouts/`，项目模板输出到 `workspace/<项目>/templates/`
...
```bash
ls -la "skills/ppt_master_workflow/templates/layouts/<新模板名称>"
```
...
**模板名称**: <新模板名称>（<中文名称>）
**模板路径**: `skills/ppt_master_workflow/templates/layouts/<新模板名称>/`
