...
USAGE = dedent(
    """
    PPT Master image orientation helper.

    Usage:
        python3 skills/ppt_master_workflow/commands/rotate_images.py auto <images_directory>
        python3 skills/ppt_master_workflow/commands/rotate_images.py gen <images_directory>
