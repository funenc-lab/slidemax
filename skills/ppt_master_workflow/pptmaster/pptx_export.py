...
def build_parser(canvas_formats: Dict[str, dict], transition_choices: Sequence[str]) -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="PPT Master - SVG to PPTX exporter",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
Examples:
    %(prog)s skills/ppt_master_workflow/examples/demo_project_intro_ppt169_20251211 -s final
    %(prog)s skills/ppt_master_workflow/examples/demo_project_intro_ppt169_20251211 --no-compat
    %(prog)s skills/ppt_master_workflow/examples/demo_project_intro_ppt169_20251211 --transition fade
...
def print_context_summary(context: PptxExportContext) -> None:
    ...
    print("PPT Master - SVG to PPTX exporter")
    print("=" * 50)
