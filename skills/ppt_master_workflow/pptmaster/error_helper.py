    ...
    BASE_ERROR_SOLUTIONS = {
        'missing_readme': {
            ...
            'solutions': [
                ...
                'Reference template: skills/ppt_master_workflow/examples/ppt169_谷歌风_google_annual_report/README.md',
                'Or copy: cp skills/ppt_master_workflow/examples/ppt169_谷歌风_google_annual_report/README.md <your_project>/'
            ],
            'severity': 'error'
        },
        'missing_spec': {
