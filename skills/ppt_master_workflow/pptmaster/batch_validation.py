"""Shared batch project validation service for PPT Master."""
...
class BatchValidator:
    """Validate multiple PPT Master projects and aggregate their results."""
    ...
    def print_summary(self) -> None:
        ...
        if self.summary['has_errors'] > 0 or self.summary['has_warnings'] > 0:
            ...
            if self.summary['missing_readme'] > 0:
                ...
                print('     Reference: skills/ppt_master_workflow/examples/ppt169_谷歌风_google_annual_report/README.md')
    ...
    def export_report(self, output_file: str = 'validation_report.txt') -> None:
        ...
        with output_path.open('w', encoding='utf-8') as handle:
            handle.write('PPT Master Project Validation Report\n')
            handle.write('=' * 80 + '\n\n')
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description='PPT Master batch project validator',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
Examples:
  %(prog)s skills/ppt_master_workflow/examples
  %(prog)s skills/ppt_master_workflow/examples workspace
  %(prog)s --all
  %(prog)s skills/ppt_master_workflow/examples --export --output validation_report.txt
''',
    )
