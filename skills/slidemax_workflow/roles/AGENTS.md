...
This file is the canonical role entry and handoff handbook for `skills/slidemax_workflow/roles/`.
...
|
+-- Need reusable page templates only? ------ yes -> read `Template_Designer.md`
|
...
| Delivery completion claim | `svg_final/`, notes coverage, `.pptx` | Completion / handoff | `project_manager validate` passes |
...
- Use `Optimizer_CRAP.md` after a first complete draft, not before, and re-run the Stage 7 delivery path after optimizer edits.
- Treat `project_manager doctor` as preflight only; final completion claims require `project_manager validate`.

## Role Guide Index

Use `guides/` when a role entry points to dense reference material.

| Guide | Purpose |
|-------|---------|
| [guides/strategist-confirmations.md](./guides/strategist-confirmations.md) | Strategist confirmation block, route selection, icon policy, and typography defaults |
| [guides/strategist-image-planning.md](./guides/strategist-image-planning.md) | Strategist image resource planning and `analyze_images` rules |
| [guides/strategist-design-brief-contract.md](./guides/strategist-design-brief-contract.md) | Strategist output structure and handoff contract |
| [guides/image-generator-prompt-pack.md](./guides/image-generator-prompt-pack.md) | Image_Generator prompt-pack and acquisition contract |
...
| **Template Designer** | [Template_Designer.md](./Template_Designer.md) | Reusable page template creation | Use the `workflows/create-template.md` entry |
...
See [Canvas Formats](../references/docs/canvas_formats.md) for the full matrix.
...
| [Design Guidelines](../references/docs/design_guidelines.md) | Detailed color, typography, and layout rules |
| [Canvas Formats](../references/docs/canvas_formats.md) | Canvas matrix and format constraints |
| [Image Prompt Guidance](../references/docs/image_prompt_guidance.md) | Asset prompt-pack structure and routing |
