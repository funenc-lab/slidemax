...
本目录存放 `skills/slidemax_workflow/` 的支持性文档，用于解释工作流、设计规范、图片规范、导出与操作手册。

## 当前规范

- **唯一 workflow source of truth**：`skills/slidemax_workflow/`
- **完整规则手册入口**：[`../AGENTS.md`](../AGENTS.md)
- **工作流入口文档**：[`../workflows/generate-ppt.md`](../workflows/generate-ppt.md)
- **命令入口目录**：[`../commands/`](../commands/)
- **共享 Python 核心**：[`../slidemax/`](../slidemax/)
...
- 命令、实现与文档说明不一致时，以 `../commands/` 与 `../slidemax/` 的现状为准并回补文档。
