...
- Module: `../slidemax/video_generation.py`
- Command: `../commands/doubao_i2v_task.py`
- Env template: `../examples/config/slidemax_ark.env.example`
...
```bash
cp skills/slidemax_workflow/examples/config/slidemax_ark.env.example .env.slidemax-ark
source .env.slidemax-ark
```
...
```bash
python3 skills/slidemax_workflow/commands/doubao_i2v_task.py create \
...
```bash
python3 skills/slidemax_workflow/commands/doubao_i2v_task.py run \
  "Fast drone flight through a canyon" \
  --image-url "https://example.com/reference.png" \
...
```bash
python3 skills/slidemax_workflow/commands/doubao_i2v_task.py status <task_id>
```

Download from a signed video URL:

```bash
python3 skills/slidemax_workflow/commands/doubao_i2v_task.py download \
