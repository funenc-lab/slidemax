...
```bash
python3 skills/slidemax_workflow/commands/pdf_to_md.py <文件路径>
python3 skills/slidemax_workflow/commands/project_manager.py init <项目名称> --format ppt169
```
...
```bash
node skills/slidemax_workflow/commands/web_to_md.cjs <URL>
```
