...
```bash
# 复制通用风格模板到项目
cp skills/slidemax_workflow/templates/layouts/general/* workspace/<项目>/templates/

# 复制咨询风格模板到项目
cp skills/slidemax_workflow/templates/layouts/consultant/* workspace/<项目>/templates/

# 复制 Google 风格模板到项目
cp skills/slidemax_workflow/templates/layouts/google_style/* workspace/<项目>/templates/

# 复制政企风格模板到项目（例：政府红）
cp skills/slidemax_workflow/templates/layouts/government_red/* workspace/<项目>/templates/
```
...
1. 在 `skills/slidemax_workflow/templates/layouts/` 下创建新目录
2. 参考现有模板结构创建必需文件
