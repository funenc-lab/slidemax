...
class ErrorHelper:
    ...
    # 错误类型和对应的修复建议
    BASE_ERROR_SOLUTIONS = {
        'missing_readme': {
            'message': '缺少 README.md 文件',
            'solutions': [
                '创建 README.md 文件，包含项目说明、使用方法等',
                'Reference template: skills/slidemax_workflow/examples/ppt169_谷歌风_google_annual_report/README.md',
                'Or copy: cp skills/slidemax_workflow/examples/ppt169_谷歌风_google_annual_report/README.md <your_project>/'
            ],
            'severity': 'error'
        },
        'missing_spec': {
