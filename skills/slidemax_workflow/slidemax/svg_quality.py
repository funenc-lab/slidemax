"""Shared SVG quality validation service for SlideMax."""
...
class SVGQualityChecker:
    """Validate SVG files against SlideMax compatibility rules."""
    ...
    def export_report(self, output_file: str = 'svg_quality_report.txt') -> None:
        ...
        with output_path.open('w', encoding='utf-8') as handle:
            handle.write('SlideMax SVG Quality Report\n')
            handle.write('=' * 80 + '\n\n')
...
Examples:
  ...
  %(prog)s --all skills/slidemax_workflow/examples
